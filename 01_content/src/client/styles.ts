...
export const css = xtermCss + '\n' + [
  ...
  '.dsh-wt_roomNav:focus-visible,.dsh-wt_roomMenuBtn:focus-visible,.dsh-wt_roomCreate:focus-visible,.dsh-wt_roomMoreBtn:focus-visible{outline:2px solid var(--dsw-alias-state-accent-primary,#4f8ef7);outline-offset:-2px}',
  ...
  '.dsh-wt_roomCreate,.dsh-wt_roomMoreBtn{height:30px;padding:4px 8px;border:1px dashed var(--dsw-alias-border-l1,#262b36);border-radius:8px;background:transparent;color:var(--dsh-sidebar-text-link);font:inherit;font-size:11px;text-align:left;cursor:pointer}',
